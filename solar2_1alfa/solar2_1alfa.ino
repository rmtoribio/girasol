...
const String PROMT= "Solar2.0alfa> ";
...
void ReadCompass(){
    ...
    compass = heading / 0.01745; 
    compass = 195 + compass;    // CALIBRADO A FUEGO.
    compass = compass % 360;
...
void loop() {
  ...
  // Cada bucle tarda 2segundos en ejecutarse.
